...
public class FitnessActivity extends AppCompatActivity {
    ...
    private String offline_or_online;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        private void initView(){
            ...
            offline_or_online = intent.getStringExtra("rejmsg");//获取键值对的键名
        ...
        viewPager.setAdapter(myFragAdaptre);
            ...
            bundle.putString("offline", offline_or_online);
            listFragment.get(0).setArguments(bundle2);
