...
public class RegisterActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String listdata = intent.getStringExtra("rmsg");//获取键值对的键名
        Log.d("RegisterActivity",listdata);
        ...
        niceSpinner.addOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                indexname = String.valueOf(dataList.get(typeindex));
                Log.d("RegisterActivity", "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm");
                Log.d("RegisterActivity", indexname);
            }
        });
                ...
                if(is==1) {
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            String test = Integer.toString(typeindex);
                            Log.d("RegisterActivity", "ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc");
